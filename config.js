...
const ASSIGN = {
  // 組別已照分數高→低排（T01 最高），所以每位業師的五組
  // 刻意混高中低分：平均名次都落在 5.4–5.6，不會有人整路只看強組或弱組。
  M2: ['T01', 'T02', 'T05', 'T09', 'T10'],
  M3: ['T01', 'T03', 'T06', 'T08', 'T10'],
  M4: ['T02', 'T04', 'T06', 'T07', 'T09'],
  M5: ['T03', 'T04', 'T05', 'T07', 'T08'],
};
