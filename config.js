    ...
    blocks: [
      { from: '10:00', to: '10:25', label: '開場',
        ...
        todo: ['請學員掃名牌 QR 進學員入口，照編號選好自己，<strong>整場不要關掉分頁</strong>',
               ...
               '預告 16:00 有擂台賽、17:00 要選一位最想同組的人'] },
      { from: '10:25', to: '11:40', label: '答辯 Block 1', key: true,
        note: '每組 5 人 × 15 分（作品答辯 8′／業師追問 5′／換場 2′）',
      ...
      { from: '16:00', to: '17:00', label: '擂台賽', key: true,
        ...
        forms: ['mentor1'] },
      { from: '17:00', to: '17:20', label: '頒獎＋Day 2 行前分組',
        ...
        todo: ['先頒擂台賽冠軍的小獎勵',
               ...
               '沒配到的現場自行找人湊滿三人；編好後填進 config.js 每一列的 d2 欄，存檔重新上架',
               '當面發個人回饋摘要（錄取與否都發）'],
        forms: ['pair1'] },
    ],
  },
  2: {
    ...
    blocks: [
      { from: '10:00', to: '10:15', label: '暖身、分組、規則公開',
        you: '三人一組。<strong>重新整理</strong>表單頁面才看得到你的新組別。',
