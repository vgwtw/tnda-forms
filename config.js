...
/* ② ─── 人 ────────────────────────────────────────────────────
   一人一列。系統內部一律用 id 串資料，所以**同名同姓不會互相污染**。
     ...
     d2   Day2 分組，一組 4 人。Day1 結束後才編得出來——
  ...
  1: {
    ...
    blocks: [
      { from: '10:00', to: '10:25', label: '開場',
        note: '公開評分規準與行程說明',
        you: '打開同儕評價單、照名牌上的編號選好自己，然後<strong>整天不要關掉那個分頁</strong>。',
        todo: ['請學員掃名牌 QR 進學員入口，照編號選好自己，<strong>整場不要關掉分頁</strong>',
               '業師從業師入口選好自己是誰',
               '口頭說明同儕評價：匿名、不公開排行、不計入錄取分數',
               '預告 17:25 有擂台賽、18:25 要選一位最想同組的人'] },
      ...
      { from: '14:35', to: '14:45', label: '準備時間',
        todo: ['確認下午的順序與設備', '擂台賽的機台、手把、抽籤先備好'] },
      ...
      { from: '16:00', to: '16:10', label: '休息',
        ...
        forms: ['peer1'] },
      { from: '16:10', to: '17:25', label: '答辯 Block 4', key: true,
        note: '每室 5 人 × 15 分',
        you: '最後一輪。答辯結束前把同儕評價<strong>送出</strong>。',
        forms: ['mentor1', 'peer1'] },
      { from: '17:25', to: '18:25', label: '擂台賽', key: true,
        note: '格鬥遊戲擂台賽：先抽上場順序，輸了就換人，最後產生冠軍',
        you: '純娛樂，<strong>不計分</strong>。抽到的順序就是你上場的順序，輸了換下一位。',
        todo: ['開<strong>擂台賽上場順序</strong>那一頁抽籤，直接投影出來',
               '守擂制：第 01 位先上，贏的留在台上，輸的換下一位',
               '這一段不評分——業師趁這段把還沒補完的評分表補齊'],
        links: [{ href: 'draw.html', label: '擂台賽上場順序' }],
        forms: ['mentor1'] },
      { from: '18:25', to: '18:45', label: '頒獎＋Day 2 行前分組',
        note: '擂台賽頒獎，接著配對 Day 2 分組',
        you: '頒完獎後填<strong>「選一位最想同組的人」</strong>——只能選一位。' +
             '互相選到就直接成一組，沒配到的現場自行找人。',
        todo: ['先頒擂台賽冠軍的小獎勵',
               '請全員填「選一位最想同組的人」，<strong>當場等它收齊</strong>',
               '儀表板 →「D1 同儕訊號」→ 開主辦模式看互選配對，宣布成功配對的組',
               '沒配到的現場自行找人湊滿 4 人；編好後填進 config.js 每一列的 d2 欄，存檔重新上架',
               '當面發個人回饋摘要（錄取與否都發）'],
        forms: ['pair1'] },
    ],
  },
  2: {
    ...
    blocks: [
      { from: '10:00', to: '10:15', label: '暖身、分組、規則公開',
        you: '4 人一組。<strong>重新整理</strong>表單頁面才看得到你的新組別。',
